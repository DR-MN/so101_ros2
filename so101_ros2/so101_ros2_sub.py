#Publish what ever data is received from both arms - it may degree or radians. 
...
class LeRobotJointStateSubscriber(Node):
    ...
    def publish_follower_states(self):
        ...
        try:
            ...
            follower_msg.position = [float(v) for v in device_state.values()]
    ...
    def joint_states_callback(self, msg: JointState):
        ...
        for joint_name, joint_value in zip(msg.name, msg.position):
            ...
            joint_states[joint_name] = float(joint_value)
