...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'so101_inference_node = so101_ros2.so101_inference_node:main',
            'so101_inference_node_with_conversion = so101_ros2.so101_inference_node_with_conversion:main',
            'so101_test_inference = so101_ros2.so101_test_inference:main',
            'so101_moveit_bridge = so101_ros2.so101_moveit_bridge:main'
        ],
    },
)
